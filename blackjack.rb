# Purpose of Program is to calculate the correct value of each card in a hand
# since ace value can have several values
...
def strip_symbol(hand)
  hand.map{ |element| element.chop} #takes of symbol (last character of each element)
end
...
def score(hand)
  ...
  elsif !check_if_ace?(strip_symbol(hand))
